...
func (SubjectTypeModel) TableName() string {
	return "subject_types"
}

func (d *SubjectTypeModel) BeforeCreate(tx *gorm.DB) (err error) {
	if d.ID == uuid.Nil {
		d.ID = uuid.New()
	}
...
func (d *SubjectTypeModel) BeforeUpdate(tx *gorm.DB) (err error) {
	d.UpdatedAt = time.Now()
	// set data from jwt token
...
func (d *SubjectTypeModel) BeforeDelete(tx *gorm.DB) (err error) {
